...
def create_profile(file):
    ...
    keyword_dict = pd.read_csv('/home/david/PY310v/Resume_EX/NLP_Resume/template/template.csv', encoding='ISO-8859-1')
...
sample2=new_data.to_csv('/home/david/PY310v/Resume_EX/NLP_Resume/template/EXselect_attr.csv')
